    ...
    return (
        <Tab.Navigator
            ...
            <Tab.Screen
                ...
                headerLeft: (title) => {
                    return (
                        <Text style={{ color: colors.primary, fontSize: 28, fontWeight: 600, marginLeft: Utils.ScreenWidth(5) }}>फसल</Text>
                    )
                },
                headerRight: () => {
                    return (
            ...
            <Tab.Screen
                ...
                headerLeft: (title) => {
                    return (
                        <Text style={{ color: colors.black, fontSize: 20, fontWeight: 600, marginLeft: Utils.ScreenWidth(5) }}>Your Orders</Text>
                    )
                },
                headerRight: () => {
                    return (
                    ...
                    tabBarIcon: ({ focused }) => {
                        return (
                            <RenderTabIcon
                                title="Orders"
                                isFocused={focused}
                                activeIcon={{uri:"https://cdn-icons-png.flaticon.com/512/839/839860.png"}}
                            // inActiveIcon={ImagesPath.Tabbar.bottom_k}
                            // title={"Katlego"}
                            />
                        )
            ...
            <Tab.Screen
                ...
                headerLeft: (title) => {
                    return (
                        <Text style={{ color: colors.black, fontSize: 20, fontWeight: 600, marginLeft: Utils.ScreenWidth(5) }}></Text>
                    )
                },
                headerRight: () => {
                    return (
                    ...
                    tabBarIcon: ({ focused }) => {
                        return (
                            <RenderTabIcon
                                title="Well Being"
                                isFocused={focused}
                                activeIcon={{uri:"https://cdn-icons-png.flaticon.com/512/1460/1460537.png"}}
                            // inActiveIcon={ImagesPath.Tabbar.bottom_k}
                            // title={"Katlego"}
                            />
                        )
