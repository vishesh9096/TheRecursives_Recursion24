...
function AgriLogin(props) {
    ...
    const signInApi = () => {
        ...
        Helper.makeRequest({ url: ApiUrl.generateotp, data: body, method: "POST" }).then((data) => {
            ...
            navigation.navigate("AgriOtp",{phno:number})
    ...
    return (
        <SafeAreaView style={styles.container}>
            ...
            {navigation.navigate("AgriOtp",{phno:number})}}><Text>testings</Text></TouchableOpacity>
        </SafeAreaView>
    )
}


export default AgriLogin