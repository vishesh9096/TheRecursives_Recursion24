                ...
                <View style={{ width: '100%', flexDirection: 'column', justifyContent: 'space-between' }}>
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginVertical: Utils.ScreenHeight(3) }}>
                        ...
                        <TouchableOpacity onPress={() => {
                            ...
                            <Text style={{ textAlign: 'center', fontSize: 14, color: colors.primary, fontWeight: 'bold', marginVertical: 7 }}>Your Orders</Text>
                        </TouchableOpacity>
                    </View>
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                        ...
                        <TouchableOpacity onPress={() => {
                            ...
                            { marginLeft: Utils.ScreenWidth(3) }]} source={{uri:"https://cdn-icons-png.flaticon.com/512/3186/3186858.png"}} />
                            <Text style={{ textAlign: 'center', fontSize: 14, color: colors.primary, fontWeight: 'bold', marginVertical: 7 }}>Transactions</Text>
                        </TouchableOpacity>
                    </View>
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginVertical: Utils.ScreenHeight(3) }}>
                        <TouchableOpacity onPress={() => {
                        ...
                        <TouchableOpacity
                            ...
                            <Image
                            tintColor={colors.primary}
                            style={styles.addIconCss} source={{uri:"https://cdn-icons-png.flaticon.com/512/2897/2897616.png"}} />
                            <Text style={{ textAlign: 'center', fontSize: 14, color: colors.primary, fontWeight: 'bold', marginVertical: 7 }}>Inventory </Text>
                        </TouchableOpacity>
                    </View>
                </View>
            </ScrollView>
