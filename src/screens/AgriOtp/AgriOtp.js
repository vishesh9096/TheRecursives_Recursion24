            ...
            <ScrollView
                ...
                <View style={styles.boxCss}>
                    ...
                    <View style={{ flexDirection: 'row', alignSelf: 'center' }}>
                        ...
                        <Text onPress={()=>navigation.navigate("AgriHome")} style={[styles.Resend, { color: colors.primary }]}>Resend OTP</Text>
                    </View>
