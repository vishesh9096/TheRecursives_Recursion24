import { View, Text, SafeAreaView, Image, ScrollView, VirtualizedList, Switch } from 'react-native'
...
const ClientProfileScreen = () => {
    ...
    const [allDay, setIAllDay] = useState(false);
    return (
                    ...
                    <View style={{ marginHorizontal: Utils.ScreenWidth(5) }}>
                        ...
                        style={{ borderWidth: 0.5, marginTop: Utils.ScreenHeight(2), borderColor: colors.grey2, borderRadius: 6, height: Utils.ScreenHeight(6), justifyContent: "center" }} >
                            <View style={{ flexDirection: "row", alignItems: "center", marginHorizontal: Utils.ScreenWidth(4), justifyContent: "space-between" }}>
                                <Text style={{ color: colors.black, fontWeight: '400', fontSize: 16 }}>Your Wallet</Text>
                        ...
                        <TouchableOpacity style={{ borderWidth: 0.5, marginTop: Utils.ScreenHeight(2), borderColor: colors.grey2, borderRadius: 6, height: Utils.ScreenHeight(6), justifyContent: "center" }} >
                            <View style={{ flexDirection: "row", alignItems: "center", marginHorizontal: Utils.ScreenWidth(4), justifyContent: "space-between" }}>
                                <Text style={{ color: colors.black, fontWeight: '400', fontSize: 16 }}>Your QR code</Text>
                        ...
                        <TouchableOpacity style={{ borderWidth: 0.5, marginTop: Utils.ScreenHeight(2), borderColor: colors.grey2, borderRadius: 6, height: Utils.ScreenHeight(6), justifyContent: "center" }} >
                            <View style={{ flexDirection: "row", alignItems: "center", marginHorizontal: Utils.ScreenWidth(4), justifyContent: "space-between" }}>
                                <Text style={{ color: colors.black, fontWeight: '400', fontSize: 16 }}>Share Data with research Organizations?</Text>
                            ...
                            onValueChange={() => { setIAllDay(!allDay) }}
                            style={{ width: Utils.ScreenWidth(10), height: Utils.ScreenHeight(4) }}
                            thumbColor={allDay ? colors.white : colors.white}
