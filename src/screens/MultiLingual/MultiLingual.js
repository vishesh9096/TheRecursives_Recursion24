import { View, Text, TouchableOpacity, SafeAreaView, StyleSheet, Modal, FlatList } from 'react-native'
  ...
  return (
    ...
    <SafeAreaView style={{ backgroundColor: colors.white }}>
      ...
      <TouchableOpacity style={{
        borderWidth: 0.5,
        width: '90%', height: 50, borderRadius: 10, justifyContent: 'center', alignItems: 'center', marginTop: Utils.ScreenHeight(50), marginLeft: Utils.ScreenWidth(5)
      }} onPress={() => {
        setLangModalVisible(!langModalVisible)
      }}>
        <Text style={{ fontSize: 16, fontWeight: '800' }}>Select Language </Text>
