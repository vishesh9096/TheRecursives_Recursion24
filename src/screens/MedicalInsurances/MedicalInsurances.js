...
const MedicalInsurances = (props) => {
  ...
  const pdf_url = "https://3715-2401-4900-57af-7d7f-ad01-4a89-1a18-af08.ngrok-free.app/static/prescription/ee.pdf"
  const url = pdf_url
    ...
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: colors.grey2 }}>
            ...
            <View style={{ margin: Utils.ScreenHeight(3), flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
                ...
                >
                    <Text style={{ textAlign: 'center', fontSize: 15, color: colors.white }}>Claim</Text>
                </TouchableOpacity>
            </View>
