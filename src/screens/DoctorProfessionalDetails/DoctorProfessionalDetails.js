...
formdata.append("mobile_no", "9644679096");
...
fetch("https://3715-2401-4900-57af-7d7f-ad01-4a89-1a18-af08.ngrok-free.app/api/user-registration/", requestOptions)
  .then(response => response.json())
  .then(result =>{
    console.log("idar hai mera data",result);
    var formdata = new FormData();
...
fetch("https://f043-2401-4900-57c0-42e0-89fe-ae5d-4114-fcfb.ngrok-free.app/upload", requestOptions)
  .then(response => response.json())
